...
for name in HOME DISPLAY WAYLAND_DISPLAY XDG_SESSION_TYPE XAUTHORITY XDG_RUNTIME_DIR DBUS_SESSION_BUS_ADDRESS PORT CAPTURE_HOST CAPTURE_SECONDS CAPTURE_DATA CAPTURE_VIDEO CAPTURE_EXPORT_RAW CAPTURE_STORAGE_GB VIDEO_RECORDER VIDEO_TARGET VIDEO_FPS VIDEO_BITRATE VIDEO_AUDIO_SOURCE PULSE_SERVER PULSE_COOKIE; do
