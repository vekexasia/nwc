...
| 5 | mounted yes/no | `MountComponentReplicatedState` 5620. Player deltas `02 04 01` (13:43:22) and `02 04 00` (13:59:48): member 1 bit 2 u8 looks like the mounted flag; others send member 2 u32 (mount id) and member 3 u8 5. Needs one driven mount/dismount at a known time before it goes in | todo: needs the user to mount |
